...
class _ApiService implements ApiService {
  ...
  Future<AdminInfo> getAdminInfo(token) async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<AdminInfo>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<CouponAdmin> listCoupon() async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<CouponAdmin>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ApiResponse1<List<Map<String, dynamic>>>>
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse1<List<Map<String, dynamic>>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
