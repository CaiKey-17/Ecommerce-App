...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  final TextEditingController _newVersionPriceController =
  ...
  void initState() {
    ...
    if (widget.isEdit && widget.product != null) {
      ...
      if (widget.product!["additionalImages"] != null) {
        _additionalImages = List<String>.from(
  ...
  void _saveProduct() {
    final product = {
      "id":
          widget.isEdit
              ? widget.product!["id"]
              : "#00${DateTime.now().millisecondsSinceEpoch}",
      ...
      "quantity":
          versions.isEmpty
              ...
              : (selectedVersionIndex >= 0 && selectedColorIndex >= 0
                  ...
                  : versionColorQuantities.isNotEmpty
                  ? versionColorQuantities[0][0]
                  : 0),
                ...
                TextButton(
                  onPressed: () {
                    if (_newColorController.text.isNotEmpty &&
                      ...
                      setState(() {
                        versionColors[selectedVersionIndex].add(
                          _newColorController.text,
                        );
                        versionColorPrices[selectedVersionIndex].add(
                          double.parse(_newPriceController.text),
                        );
                        versionColorQuantities[selectedVersionIndex].add(
                ...
                onPressed: () {
                  if (_newVersionController.text.isNotEmpty &&
                    ...
                    setState(() {
                      ...
                      if (selectedColorIndex == -1 && !hasColors)
                        selectedColorIndex = 0;
                    });
  ...
  void _addSpecification() {
    if (_valueController.text.isNotEmpty &&
      ...
      setState(() {
        ...
        String specString = specifications
            .map((spec) {
  ...
  void _deleteVersion(int index) {
    setState(() {
      ...
      if (versions.isEmpty) {
        ...
        selectedColorIndex =
            versionColors[selectedVersionIndex].isEmpty ? -1 : 0;
      }
    });
  }
    ...
    setState(() {
      ...
      if (versionColors[selectedVersionIndex].isEmpty) {
        selectedColorIndex = -1;
          ...
          versionColors[selectedVersionIndex].length) {
  ...
  double _calculateColorPrice(int versionIndex, int colorIndex) {
    double basePrice = _calculateDiscountedPrice();
    return basePrice +
        priceModifiers[versionIndex] +
        versionColorPrices[versionIndex][colorIndex];
  }
            ...
            if (showVersionSection) ...[
                          ...
                          GestureDetector(
                            onTap: () {
                              setState(() {
                                ...
                                selectedColorIndex =
                                    hasColors && versionColors[index].isNotEmpty
                                        ? 0
                                        : -1;
                              });
                            },
                              ...
                              child: Column(
                                children: [
                                  ...
                                  if (!hasColors) ...[
                                    ...
                                    if (versionColorQuantities[index]
                                        .isNotEmpty)
                                      Text(
              ...
              if (hasColors && selectedVersionIndex >= 0) ...[
                ...
                Row(
                  ...
                  children: [
                    Text(
                      "Màu sắc (${versions[selectedVersionIndex]}):",
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                      ),
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    children: [
                                      Text(
                                        versionColors[selectedVersionIndex][index],
                                        style: TextStyle(
                                          fontSize: 14,
                                          fontWeight: FontWeight.bold,
                                        ),
