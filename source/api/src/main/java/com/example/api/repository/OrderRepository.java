...
public interface OrderRepository extends JpaRepository<Order, Integer> {
    ...
    @Query(value = """
        ...
        WHERE o.id_fk_customer = :customerId AND o.process = :process
        GROUP BY o.id, o.created_at, o.total
        """, nativeQuery = true)
    List<OrderSummaryDTO> findStatusOrdersByCustomerId(@Param("customerId") Integer customerId,@Param("process") String process,@Param("status") String status );
